...
const char* StructureScanComplexItem::altitudeRelativeName =        "AltitudeRelative";
const char* StructureScanComplexItem::layersName =                  "Layers";
const char* StructureScanComplexItem::layerDistanceName =           "LayerDistance";
const char* StructureScanComplexItem::cameraTriggerDistanceName =   "CameraTriggerDistance";
...
StructureScanComplexItem::StructureScanComplexItem(Vehicle* vehicle, QObject* parent)
    ...
    , _altitudeRelativeFact     (settingsGroup, _metaDataMap[altitudeRelativeName])
    , _layersFact               (settingsGroup, _metaDataMap[layersName])
    , _layerDistanceFact        (settingsGroup, _metaDataMap[layerDistanceName])
    , _cameraTriggerDistanceFact(settingsGroup, _metaDataMap[cameraTriggerDistanceName])
{
    ...
    connect(&_altitudeFact,                 &Fact::valueChanged, this, &StructureScanComplexItem::_updateCoordinateAltitude);
    connect(&_altitudeRelativeFact,         &Fact::valueChanged, this, &StructureScanComplexItem::_setDirty);
...
void StructureScanComplexItem::_setExitCoordinate(const QGeoCoordinate& coordinate)
{
...
// FIXME: Move to QGCMapPolygon to standardize
void StructureScanComplexItem::_swapPoints(QList<QPointF>& points, int index1, int index2)
{
...
qreal StructureScanComplexItem::_ccw(QPointF pt1, QPointF pt2, QPointF pt3)
{
    return (pt2.x()-pt1.x())*(pt3.y()-pt1.y()) - (pt2.y()-pt1.y())*(pt3.x()-pt1.x());
}

qreal StructureScanComplexItem::_dp(QPointF pt1, QPointF pt2)
{
    return (pt2.x()-pt1.x())/qSqrt((pt2.x()-pt1.x())*(pt2.x()-pt1.x()) + (pt2.y()-pt1.y())*(pt2.y()-pt1.y()));
}

QList<QPointF> StructureScanComplexItem::_convexPolygon(const QList<QPointF>& polygon)
{
...
void StructureScanComplexItem::_updateCoordinateAltitude(void)
{
    _coordinate.setAltitude(_altitudeFact.rawValue().toDouble());
    _exitCoordinate.setAltitude(_altitudeFact.rawValue().toDouble());
    emit coordinateChanged(_coordinate);
...
void StructureScanComplexItem::appendMissionItems(QList<MissionItem*>& items, QObject* missionItemParent)
{
    ...
    bool altitudeRelative = _altitudeRelativeFact.rawValue().toBool();
